...
const ALLOWED_MIME_TYPES = ["image/png", "image/jpeg", "image/jpg", "video/mp4", "video/webm", "video/ogg", "video/quicktime"];
const ALLOWED_EXTENSIONS = [".png", ".jpg", ".jpeg", ".mp4", ".webm", ".ogg", ".mov"];
...
class ImageService {
    ...
    async validateImageFile(file: any) {
        ...
        if (!ALLOWED_MIME_TYPES.includes(mimeType)) {
            throw new Error("Invalid file type. Images and videos allowed");
        }
